...
class TestMyLogisticRegression(unittest.TestCase):
	...
	def test_basic_play_game_1(self):
		...
		ans = accuracy >=0.38 and precision[0] >= 0.61 and recall[0] >= 0.13 \
            	and f1[0] >= 0.35 and support[0] >=10 \
                and precision[1] >= 0.32 and recall[1] >= 0.75 \
            	and f1[1] >= 0.47 and support[1] >=11
		print('\nexpected results:')
		print('Accuracy: 0.90')
