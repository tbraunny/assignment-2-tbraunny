...
class TestMyLogisticRegression(unittest.TestCase):
	...
	def test_basic_play_game_1(self):
		...
		ans = accuracy >=0.45 and precision[0] >= 0.62 and recall[0] >= 0.23 \
            	and f1[0] >= 0.34 and support[0] >=21 \
                and precision[1] >= 0.40 and recall[1] >= 0.78 \
            	and f1[1] >= 0.53 and support[1] >=14
		print('\nexpected results:')
		print('Accuracy: 0.90')
